...
omxplayer -o hdmi --win '330 110 1680 910' /media/PiShare/jerrie-meet.mov #launch the video // TO DO: replace this with variables for video and window size, or make easily replacable