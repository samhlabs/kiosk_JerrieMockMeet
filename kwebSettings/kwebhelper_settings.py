...
direct_commands = ['kwebhelper.py','omxplayergui.py','kwebhelper_set.py','omxplayer','gksudo','xterm','/media/PiShare/Git/kiosk_JerrieMockWorld/startOMX.sh','/media/PiShare/Git/kiosk_JerrieMockWorld/startCCOMX.sh','/media/PiShare/Git/kiosk_JerrieMockWorld/stopOMX.sh','/media/PiShare/Git/kiosk_JerrieMockWorld/volumeUp.sh','/media/PiShare/Git/kiosk_JerrieMockWorld/volumeDown.sh']
