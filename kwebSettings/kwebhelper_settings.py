...
direct_commands = ['kwebhelper.py','omxplayergui.py','kwebhelper_set.py','omxplayer','gksudo','xterm','/media/PiShare/Git/kiosk_JerrieMockMeet/startOMX.sh','/media/PiShare/Git/kiosk_JerrieMockMeet/startCCOMX.sh','/media/PiShare/Git/kiosk_JerrieMockMeet/stopOMX.sh','/media/PiShare/Git/kiosk_JerrieMockMeet/volumeUp.sh','/media/PiShare/Git/kiosk_JerrieMockMeet/volumeDown.sh']
